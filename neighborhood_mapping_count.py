...
landlord_counts = parcels.groupby(["MailingAddress", "Owner"]).size().reset_index(name="Number of Properties")
is_major_owner = landlord_counts['Number of Properties'] >= 4
landlord_counts = landlord_counts[is_major_owner]
landlord_counts = landlord_counts.sort_values(by='Number of Properties',ascending=False)
