...
parcels['highlight'] = np.where(parcels['MailingAddress'] == "1333 PARK AVE EMERYVILLE CA 94608", 'yes', 'no') # prepares us to highlight parcels with a particular mailing address (our proxy for ownership)
